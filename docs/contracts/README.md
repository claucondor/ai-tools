...
Reference documentation for the JanusToken and JanusFlow contract layer.

| File | Contents |
|------|----------|
| [janus-token.md](janus-token.md) | JanusToken Solidity standard — interface, modes, events, encoding |
